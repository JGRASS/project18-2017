...
public class Obrisi_Pitanje extends JDialog {
	...
	public JPanel getPanel_1() {
		if (panel_1 == null) {
			...
			panel_1.add(getBtnObrisiPitanje());
	...
	public JTextArea getTextPane_1() {
		if (txtNapisitePitanje == null) {
			...
			txtNapisitePitanje.setBackground(Color.WHITE);
	...
	public JTextField getTxtPrviOdgovor() {
		if (txtPrviOdgovor == null) {
			...
			txtPrviOdgovor.setBackground(Color.WHITE);
			txtPrviOdgovor.setEditable(false);
	...
	public JTextField getTxtDrugiOdgovor() {
		if (txtDrugiOdgovor == null) {
			...
			txtDrugiOdgovor.setBackground(Color.WHITE);
			txtDrugiOdgovor.setEditable(false);
	...
	public JTextField getTxtTreciOdgovor() {
		if (txtTreciOdgovor == null) {
			...
			txtTreciOdgovor.setBackground(Color.WHITE);
			txtTreciOdgovor.setEditable(false);
